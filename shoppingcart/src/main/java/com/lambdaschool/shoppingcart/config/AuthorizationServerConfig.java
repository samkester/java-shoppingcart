...
//    static final String CLIENT_SECRET = "lambda-secret"; // much less secure but useful if environment variables are kvetching
    ...
    static final int ACCESS_TOKEN_VALIDITY_SECONDS = -1; // or a timeout in seconds
